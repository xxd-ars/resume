...
\resumeSubHeadingListStart
    ...
    {Master of Engineering (Deep Learning and Mechanical Engineering)}{Shanghai, China}
        \resumeItemListStart
        \resumeItem{Developed a dual-modality deep learning framework (DIUA-YOLO) for automated blood layer detection, integrating cross-illumination attention to enhance clinical examination analysis accuracy.}
        \resumeItemListEnd
    \resumeSubheading
    ...
    {Bachelor of Engineering (Mechanical Engineering)}{Shanghai, China}
        \resumeItemListStart
        \resumeItem{Relevant courses: Dynamical System, Stability and Control, Continuum Mechanics, Fluid Mechanics, Quantum Mechanics}
...
\resumeSubHeadingListStart
    \resumeSubheading
    {DeepDyna AI}{Dec 2024 -- Present}
    {Software, LLM Engineer}{Shanghai, China}
      \resumeItemListStart
